...
from agent import CooperativeQLearningAgent
import config
from ai_game import (
    GRASS,
    TRACK,
...
def train():
    ...
    agent = CooperativeQLearningAgent(
    ...
    pygame.display.set_caption("Cooperative RL Car Racing Game")
    ...
    for episode in range(config.NUM_EPISODES):
        ...
        while not population_done:
            ...
            # Update Q-values using shared knowledge
            ...
            texts = [
                ...
                "",
                f"Q-Table Size: {len(agent.get_q_table())}",
            ]
        ...
        # No need to clone Q-table since all agents share the same one
